...
class TransfuserConfig:
    ...
    bkb_path: str = "/root/clone/DiffusionDriveV2/ckpt/resnet34.a1_in1k/pytorch_model.bin"
    plan_anchor_path: str = "/root/clone/DiffusionDriveV2/ckpt/resnet34.a1_in1k/kmeans_navsim_traj_20.npy"
