...
class RigidNodes(VanillaGaussians):
    ...
    def load_state_dict(self, state_dict: Dict, **kwargs) -> str:
        self.point_ids = state_dict.pop("points_ids").to(self.device)
        self.instances_size = state_dict.pop("instances_size").to(self.device)
        self.instances_fv = state_dict.pop("instances_fv").to(self.device)
