...
DEFAULT_CKPTS = [
    "/root/clone/ReconDreamer-RL/SparseDriveV2/ckpt/sparsedrive_stage2.pth",         # PPO fine-tune
    "/root/clone/ReconDreamer-RL/SparseDriveV2/ckpt/sparsedrive_stage2.pth",     # Reinforce++ fine-tune
