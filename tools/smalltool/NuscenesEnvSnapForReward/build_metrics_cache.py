...
Usage:
    python tools/smalltool/build_metrics_cache.py --scene 0 --root /OpenDataset/nuscenes/nuscenes/v1.0-trainval --version v1.0-trainval
    python tools/smalltool/build_metrics_cache.py --scene 1
"""
