...
PYTHONPATH=/root/clone/ReconDreamer-RL python -u script/train_actor_learner_v2.py \
  --role orchestrator \
  --config /root/clone/ReconDreamer-RL/script/configs/sparsedrive_v2/202606130003_HUGSM_reinforcepp_closed_loop_steppath_hd_OnlyGRPOPdm_auxRiskDecel_substeps1.yaml
#如果一直启动不起来卡在gsplat编译:
